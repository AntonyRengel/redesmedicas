...
public class VCalendarioPrueba extends JPanel {
     ...
     */
    VCalendarioPrueba(int year, int month, int today) {
        super();
    ...
    private void buildGUI() {
       ...
       add(BorderLayout.CENTER, tp);
        ...
        bp.add(b0 = new JButton("Sabado"));
        bp.add(new JButton("Lunes"));
        bp.add(new JButton("Martes"));
        bp.add(new JButton("Miercoles"));
        bp.add(new JButton("Jueves"));
        bp.add(new JButton("Viernes"));
        bp.add(new JButton("Domingo"));
